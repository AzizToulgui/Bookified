...
<img src="https://img.shields.io/badge/-Shadcn/UI-000000?style=for-the-badge&logo=shadcnui&logoColor=white" />
  ...
  <h3 align="center">AI Book Companion | Reading Buddy</h3>
</div>
...
Bookified is an AI-powered platform that lets you have real-time voice conversations with your books. Built with Next.js 16, Vapi, and MongoDB, it transforms PDFs into interactive entities using natural voice synthesis. Choose from custom personas to chat with your library, request summaries, and view live transcripts—all wrapped in a sleek Shadcn UI with Clerk authentication.
...
- **[Vapi](https://vapi.ai/?aff=website&gad_source=1&gad_campaignid=21766561152&gbraid=0AAAAADjmL09ds2GZzvYNFnnIm1gVi1QGi&gclid=Cj0KCQjw77bPBhC_ARIsAGAjjV_n-NOttqgwGOLAjh4eE_YvYpNCTNyfWSIRJjx-J2AwXQ1hliX6iXIaAgcjEALw_wcB)** is a specialized Voice AI platform that enables real-time, low-latency conversational audio. It serves as the primary engine for Bookified, allowing users to have seamless, back-and-forth verbal interactions with their uploaded content.
...
👉 **AI Voice Personas**: Choose from a variety of distinct AI personalities and hear instant high-fidelity previews powered by Vapi to find the perfect reading companion.
...
```bash
git clone https://github.com/AzizToulgui/Bookified.git
cd bookified
```
...
Replace the placeholder values with your real credentials. You can get these by signing up at: [**Clerk**](https://clerk.com), [**Vercel**](https://vercel.com), [**MongoDB**](https://www.mongodb.com), [**Vapi**](https://vapi.ai).
...
Thank you for taking the time to explore **Bookified**.  
This project was built with passion to make reading more interactive, engaging, and powered by AI.

Special thanks to everyone who supports this project, contributes ideas, tests features, or simply uses it. Your support truly means a lot! 🚀
...
Click the ⭐ button at the top of this page — it only takes a second and helps a lot!
